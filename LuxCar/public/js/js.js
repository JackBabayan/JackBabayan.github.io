...
$(document).ready(function(){
  ...
  items:1
   ...
   $(".tab_item").not(":first").hide();
    $(".wrapper .tema").click(function() {
      $(".wrapper .tema").removeClass("active").eq($(this).index()).addClass("active");
     ...
     function Calendar3(id, year, month) {
          ...
          m.selected = true;
          if (document.querySelectorAll('#'+id+' tbody tr').length < 5) {
              document.querySelector('#'+id+' tbody').innerHTML += '<tr><td>&nbsp;<td>&nbsp;<td>&nbsp;<td>&nbsp;<td>&nbsp;<td>&nbsp;<td>&nbsp;';
          }
          document.querySelector('#'+id+' option[value="' + new Date().getMonth() + '"]').style.color = '#fff'; // в выпадающем списке выделен текущий месяц
          }
          ...
          $(".img-conteyner").click(function(){
            $('.popup_overlay').fadeIn(400);
            $(this).children('.galery,.popup_overlay').fadeIn(400);
          });
          $('.popup_overlay').click(function(){
            $('.popup_overlay').fadeOut(400);
            $('.galery,.popup_overlay').fadeOut(400);
          });


          $(".img-conteyner-news").click(function(){
            $('.popup_overlay').fadeIn(400);
            $(this).children('.galery,.popup_overlay').fadeIn(400);
          });
          $('.popup_overlay').click(function(){
